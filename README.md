...
# 🚀 프로젝트 진행 및 성과
 ## 1. 주요 기능 선정: 어플리케이션의 핵심 기능을 결정
  ...
  | 페이지        | 주요 기능                                           | 이미지                                                      |
  |------------------------|--------------------------------------------|---------------------------------------------------------------|
  | **식재료 관리**   | 식품 등록, 수정, 삭제를 할 수 있습니다<br/>사용자의 식료품을 효율적으로 관리합니다<br/>식품 낭비를 줄이고, 사용자의 경제적 부담을 감소시킵니다 | <p align="center"><img src="https://github.com/sslee1210/singsinggo/assets/142865231/ca0630e2-a578-478e-80c7-85ad11ac4d6e.png"  width="230" height="auto"/></p> |
